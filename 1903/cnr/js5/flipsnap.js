 ...
 *
 * @version  0.5.6
 * @url //pxgrid.github.com/js-flipsnap/
 *
...
Flipsnap.prototype.init = function(element, opts) {
  ...
  self.transitionDuration = (opts.transitionDuration === undefined) ? '700ms' : opts.transitionDuration + 'ms';
...
Flipsnap.prototype.hasNext = function() {
  var self = this;
  /*무한롤링 추가*/
  //console.log("currentPoint:"+self.currentPoint);
  //console.log("_maxPoint:"+self._maxPoint);
  if(self.currentPoint == self._maxPoint) self.currentPoint = -1;
  /* */
...
Flipsnap.prototype._touchMove = function(event) {
  ...
  if (self.moveReady) {
    ...
    if (newX >= -1000 || newX < self._maxX) {            /*마우스 이동속도*/
      newX = Math.round(self.currentX + distX / 30);       
    }
